...
<div>
<img src="https://github.com/ddeveloper72/milestone-2-project/blob/master/static/images/readme/fullPageSmall.png" alt="Screenshot of the webpage"style="float: right; margin-right: 10px; margin-top: 5px; margin-bottom: 5px;"> <p>Fig 1 Webpage screenshot</p></div>
