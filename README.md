...
![alt text](https://github.com/ddeveloper72/milestone-2-project/blob/master/static/images/readme/fullPageSmall.png "Fig 1 Webpage screenshot"){:style="float: right;margin-right: 7px;margin-top: 7px;"} 
